...
def test_node_angle_calculation(sample_nodes):
...
def test_bezier_curve_calculation():
	renderer = ChordRenderer()
...
def test_chord_rendering(sample_nodes, sample_edges, view_state):
	renderer = ChordRenderer()
...
def test_chord_connection_visibility(sample_nodes, sample_edges, view_state):
    renderer = ChordRenderer()
    result = renderer.render(sample_nodes, sample_edges, view_state)
...
def test_label_positioning(sample_nodes, view_state):
    renderer = ChordRenderer()
