...
Generated on 2026-01-27T13:22:57.350586
...
SUGGESTED_MAPPINGS = {
    ...
    'southern california': 'southern california',  # Score: N/A, Reason: atomic-decompose; ALSO co-occurrence: california
    ...
    'best of 2001': 'best of 2021',  # Score: N/A, Reason: fuzzy-match; ALSO co-occurrence: 2001
    ...
    'best albums 2019': 'best albums 2021',  # Score: N/A, Reason: fuzzy-match; ALSO co-occurrence: 2019
    'best albums 2017': 'best albums 2021',  # Score: N/A, Reason: fuzzy-match; ALSO co-occurrence: 2017
    ...
    'art metal': 'party metal',  # Score: N/A, Reason: fuzzy-match
    ...
    '2019 releases': 'release',  # Score: N/A, Reason: component-map:releases; ALSO co-occurrence: 2019
...
SUGGESTED_ATOMIC_DECOMPOSITIONS = {
    'traditional metal': ['traditional', 'metal'],  # Score: N/A, Reason: atomic-candidate
    'technical thrash': ['technical', 'thrash'],  # Score: N/A, Reason: atomic-candidate
    'technical progressive metal': ['technical', 'progressive metal'],  # Score: N/A, Reason: atomic-candidate
    'technical progressive deathcore': ['technical', 'progressive deathcore'],  # Score: N/A, Reason: atomic-candidate
    'technical progressive death metal': ['technical', 'progressive death metal'],  # Score: N/A, Reason: atomic-candidate
    'synth metal': ['synth', 'metal'],  # Score: N/A, Reason: atomic-candidate
    'symphonic gothic metal': ['symphonic', 'gothic metal'],  # Score: N/A, Reason: atomic-candidate
    'symphonic experimental metal': ['symphonic', 'experimental metal'],  # Score: N/A, Reason: atomic-candidate
    'sludge stoner': ['sludge', 'stoner'],  # Score: N/A, Reason: atomic-candidate
    'rock musical': ['rock', 'musical'],  # Score: N/A, Reason: atomic-candidate
    'rock modern': ['rock', 'modern'],  # Score: N/A, Reason: atomic-candidate
    'rock metal': ['rock', 'metal'],  # Score: N/A, Reason: atomic-candidate
    'progressive stoner': ['progressive', 'stoner'],  # Score: N/A, Reason: atomic-candidate
    'progressive post metal rock': ['progressive', 'post metal rock'],  # Score: N/A, Reason: atomic-candidate
    'progressive noise rock': ['progressive', 'noise rock'],  # Score: N/A, Reason: atomic-candidate
    'progressive heavy metal': ['progressive', 'heavy metal'],  # Score: N/A, Reason: atomic-candidate
    'progressive alternative metal': ['progressive', 'alternative metal'],  # Score: N/A, Reason: atomic-candidate
    'post screamo': ['post', 'screamo'],  # Score: N/A, Reason: atomic-candidate
    'post progressive rock': ['post', 'progressive rock'],  # Score: N/A, Reason: atomic-candidate
    'on vinyl': ['on', 'vinyl'],  # Score: N/A, Reason: atomic-candidate
    'noise metal': ['noise', 'metal'],  # Score: N/A, Reason: atomic-candidate
    'new metal': ['new', 'metal'],  # Score: N/A, Reason: atomic-candidate
    'neo classical metal': ['neo classical', 'metal'],  # Score: N/A, Reason: atomic-candidate
    'modern melodic death metal': ['modern', 'melodic death metal'],  # Score: N/A, Reason: atomic-candidate
    'modern emo': ['modern', 'emo'],  # Score: N/A, Reason: atomic-candidate
    'modern alternative rock': ['modern', 'alternative rock'],  # Score: N/A, Reason: atomic-candidate
    'melancholic black metal': ['melancholic', 'black metal'],  # Score: N/A, Reason: atomic-candidate
    'jazz piano': ['jazz', 'piano'],  # Score: N/A, Reason: atomic-candidate
    'industrial dance': ['industrial', 'dance'],  # Score: N/A, Reason: atomic-candidate
    'indie emo': ['indie', 'emo'],  # Score: N/A, Reason: atomic-candidate
    'heavy progressive': ['heavy', 'progressive'],  # Score: N/A, Reason: atomic-candidate
    'heavy jazz': ['heavy', 'jazz'],  # Score: N/A, Reason: atomic-candidate
    'gothic doom': ['gothic', 'doom'],  # Score: N/A, Reason: atomic-candidate
    'folk noir': ['folk', 'noir'],  # Score: N/A, Reason: atomic-candidate
    'folk indie': ['folk', 'indie'],  # Score: N/A, Reason: atomic-candidate
    'folk doom': ['folk', 'doom'],  # Score: N/A, Reason: atomic-candidate
    'folk death metal': ['folk', 'death metal'],  # Score: N/A, Reason: atomic-candidate
    'electronic jazz': ['electronic', 'jazz'],  # Score: N/A, Reason: atomic-candidate
    'electro swing': ['electro', 'swing'],  # Score: N/A, Reason: atomic-candidate
    'electro rock': ['electro', 'rock'],  # Score: N/A, Reason: atomic-candidate
    'comedy metal': ['comedy', 'metal'],  # Score: N/A, Reason: atomic-candidate
    'chamber post metal': ['chamber', 'post metal'],  # Score: N/A, Reason: atomic-candidate
    'breakbeat hardcore': ['breakbeat', 'hardcore'],  # Score: N/A, Reason: atomic-candidate
    'black doom metal': ['black', 'doom metal'],  # Score: N/A, Reason: atomic-candidate
    'black doom': ['black', 'doom'],  # Score: N/A, Reason: atomic-candidate
    'aoty 2020': ['aoty', '2020'],  # Score: N/A, Reason: atomic-candidate
    'alternative indie rock': ['alternative', 'indie rock'],  # Score: N/A, Reason: atomic-candidate
    'alternative indie': ['alternative', 'indie'],  # Score: N/A, Reason: atomic-candidate
    'alternative folk': ['alternative', 'folk'],  # Score: N/A, Reason: atomic-candidate
    'alternative country': ['alternative', 'country'],  # Score: N/A, Reason: atomic-candidate
    'acoustic metal': ['acoustic', 'metal'],  # Score: N/A, Reason: atomic-candidate
    'acid techno': ['acid', 'techno'],  # Score: N/A, Reason: atomic-candidate
    '2020 albums': ['2020', 'albums'],  # Score: N/A, Reason: atomic-candidate; ALSO co-occurrence: 2020
    '2018 albums': ['2018', 'albums'],  # Score: N/A, Reason: atomic-candidate
}
