...
Generated on 2026-01-27T13:42:09.249987
...
SUGGESTED_MAPPINGS = {
    ...
    # 'serbian pop alchemy': 'serbia',  # LOSS OF GENRE pop
    'serbian': 'serbia',  # Score: N/A, Reason: rules-mapped-after-enhanced; ALSO co-occurrence: serbia
    # 'seattle metal': 'seattle',  # LOSS OF GENRE metal
    ...
    # 'olivia': 'bolivia',  # DANGEROUS TYPE FIX
    ...
    # 'northern silence': 'silence',  # BAD MAPPING label -> concept
    ...
    # 'indonesian black metal': 'indonesia',  # LOSS OF GENRE
    ...
    # 'english black metal': 'english',  # LOSS OF GENRE
    ...
    'eclectic metal': 'eclectic metal',  # Score: N/A, Reason: atomic-decompose; ALSO co-occurrence: ecletic metal
    ...
    # 'chilean metal': 'chile',  # LOSS OF GENRE
    ...
    # 'brazillian metal': 'brazil',  # LOSS OF GENRE
    # 'brazilian folk': 'brazil',  # LOSS OF GENRE
    ...
    # 'best of 2001': 'best of 2021',  # YEAR SWAP ERROR
    ...
    # 'best albums 2019': 'best albums 2021',  # YEAR SWAP ERROR
    # 'best albums 2017': 'best albums 2021',  # YEAR SWAP ERROR
    ...
    # 'australian metal': 'australia',  # LOSS OF GENRE
    ...
    # 'art metal': 'party metal',  # WTF
    # 'armenian folk music': 'armenia',  # LOSS OF GENRE
