#!/usr/bin/env python3
"""
Batch Application of Tag Suggestions (REVIEWED).
Based on scripts/adhoc/apply_suggestions_20260127_133441.py
"""
...
SUGGESTED_MAPPINGS = {
    ...
    # 'symphonic melodic death metal': 'metal', # REMOVED (Too Broad)
