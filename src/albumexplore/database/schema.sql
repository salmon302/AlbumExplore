...
CREATE INDEX IF NOT EXISTS tag_normalized_name_idx ON tags (normalized_name);
CREATE INDEX IF NOT EXISTS tag_variant_idx ON tag_variants (variant);
CREATE INDEX IF NOT EXISTS tag_frequency_idx ON tags (frequency);